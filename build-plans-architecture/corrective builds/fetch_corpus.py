...
Usage:
    python -m gold_standard.corpus.fetch_corpus            # download missing, verify pinned
    python -m gold_standard.corpus.fetch_corpus --force    # re-download all
    python -m gold_standard.corpus.fetch_corpus --repin    # re-compute and overwrite pinned checksums
